...
ActiveRecord::Schema.define(version: 20161010212150) do
  ...
  add_index "user_comments", ["goal_id"], name: "index_user_comments_on_goal_id", using: :btree
  ...
  add_foreign_key "user_comments", "goals"
